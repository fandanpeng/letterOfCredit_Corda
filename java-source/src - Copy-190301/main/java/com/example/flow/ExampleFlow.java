...
public class ExampleFlow {
    ...
    public static Logger logger1 = Logger.getLogger(ExampleFlow.class);
    @InitiatingFlow
    @StartableByRPC
    public static class Initiator extends FlowLogic<SignedTransaction> {
        ...
        public SignedTransaction call() throws FlowException {
            ...
            //otherPartySession.send("Send test data");
            logger1.info("Send test ");
    ...
    public static class Acceptor extends FlowLogic<SignedTransaction> {
        ...
        @Override
        public SignedTransaction call() throws FlowException {
           // UntrustworthyData<String> aa = otherPartyFlow.receive(String.class,true);
           // logger1.info("Received data: " + aa.toString());
           // String bb = aa.unwrap(tt->tt);
           // logger1.info("after unwrap: " + bb);
